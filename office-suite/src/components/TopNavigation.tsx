...
import { Search, Plus, Bell, Settings, User, Sun, Moon, MessageSquare } from "lucide-react"
...
export function TopNavigation() {
  ...
  return (
    <header
      className="h-16 bg-background border-b border-border flex items-center px-6 gap-4 fixed top-0 z-50"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <Link href="/connect" className="sm:hidden">
