-- ============================================================================
-- ADMIN CONSOLE DATABASE SCHEMA - FIXED VERSION
-- ============================================================================
...
-- Uncomment these lines if you want to start fresh (WARNING: This will delete all data!)
...
-- DROP TABLE IF EXISTS email_servers CASCADE;
...
CREATE TABLE IF NOT EXISTS email_templates (
    ...
    template_type VARCHAR(50) NOT NULL CHECK (template_type IN ('welcome', 'notification', 'marketing', 'system', 'custom')),
...
CREATE TABLE IF NOT EXISTS integrations (
    ...
    name VARCHAR(255) NOT NULL,
    description TEXT,
    integration_type VARCHAR(50) NOT NULL CHECK (integration_type IN ('oauth', 'api', 'webhook', 'smtp', 'imap', 'pop3', 'exchange')),
...
CREATE INDEX IF NOT EXISTS idx_email_servers_type ON email_servers(server_type);
